function y = graphmatching1129_partial(M,group1,group2,L12,e1,Xinit)
    if(isempty(Xinit))
    ...
    Xraw = RRWM_upload(Mpartial,group1_,group2_);
%     Xraw = RRWM_upload_init(Mpartial,group1_,group2_, Xinit(partial));
